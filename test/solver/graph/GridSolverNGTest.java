...
public class GridSolverNGTest {
    ...
    public void testMono() {
        ...
        TList<List<Integer>> result = new GridSolver(gmono,gmono.localMetric(GridMetric.l1d(), 3), point3(2,2,0),point3(6,6,4)).earlyExit().astar().solve().route();
    ...
    public void testComposite() {
        ...
        TList<List<Integer>> result = new GridSolver(gcomp,gcomp.globalMetric(GridMetric.l2d(), 3),point3(2,2,0),point3(-6,-1,0)).earlyExit().astar().solve().route();
