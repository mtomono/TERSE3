...
import solver.graphMetric.MetricNodeGraph;
import solver.graphMetric.MetricNodeGraphBuilder;

/**
 *
 * @author masao
 */
public class GridGraph4NGTest {
    BareGridGraph graph;
    TList<List<Integer>> blocks;
    public GridGraph4NGTest() {
        ...
        blocks = TList.sof(
                ...
                p3i(20,9,10),
                p3i(20,10,10)
        ).map(p->TList.set(p).sfix());
    }

    @Test
    public void testFindCost() {
        System.out.println(test.TestUtils.methodName(0));
        MetricNodeGraph<List<Integer>> d = MetricNodeGraphBuilder.<List<Integer>>builder(Metric.weighted(Metric.l1(),TList.sof(1,1,3)),graph,TList.sof(10,0,0),TList.sof(20,9,9)).earlyExit().astar().white(blocks).build();
        d.fillLoop();
    ...
    public void testFindRoute() {
        System.out.println(test.TestUtils.methodName(0));
        MetricNodeGraph<List<Integer>> d = MetricNodeGraphBuilder.<List<Integer>>builder(Metric.l1(),graph,TList.sof(10,0,0),TList.sof(20,9,9)).earlyExit().astar().white(blocks).build();
        d.fillLoop();
        TList<List<Integer>> result= d.findRoute();
        TList<List<Integer>> expected = TList.sof(p3i(10,0,0), p3i(11,0,0), p3i(12,0,0), p3i(12,0,1), p3i(12,1,1), p3i(12,1,2), p3i(12,2,2), p3i(13,2,2), p3i(13,2,3), p3i(13,3,3), p3i(14,3,3), p3i(14,3,4), p3i(14,4,4), p3i(15,4,4), p3i(15,4,5), p3i(15,5,5), p3i(16,5,5), p3i(16,5,6), p3i(16,6,6), p3i(17,6,6), p3i(17,6,7), p3i(17,7,7), p3i(18,7,7), p3i(18,7,8), p3i(18,8,8), p3i(19,8,8), p3i(19,8,9), p3i(19,9,9), p3i(20,9,9)).map(p->TList.set(p).sfix());
        System.out.println("result  : "+result);
        System.out.println("expected: "+expected);
        assertEquals(result, expected);
    }
