 ...
 * @author masao
 */
public class Line3d_InSamePlaneStrikeStartNGTest {
    Line3d tested = line3(3, 1, 1, 2, 0, 0);
    Line3d line = line3(2, 0, 1, 1, 1, 0);
    Ray3d ray = ray3(2, 0, 1, 1, 1, 0);
    Segment3d segment = segment3(2, 0, 1, 4, 2, 1);
    TPoint3d point = point3(3, 1, 1);
    
    public Line3d_InSamePlaneStrikeStartNGTest() {
    }
    ...
    public void testMove() {
        ...
        Line3d expected = line3(4, 3, 4, 2, 0, 0);
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
    ...
    public void testIntersect_Line3d() {
        System.out.println(test.TestUtils.methodName(0));
        TPoint3d result = tested.intersect(line);
