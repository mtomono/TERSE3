 ...
 * @author masao
 */
public class Ray3d_SkewAndCrossBelowNGTest {
    Ray3d tested = ray3(1, 1, 3, 2, 0, 0);
    Line3d line = line3(2, 0, 2, 1, 1, 0);
    Ray3d ray = ray3(2, 0, 2, 1, 1, 0);
    Segment3d segment = segment3(2, 0, 2, 4, 2, 2);
    TPoint3d point = point3(3, 1, 2);

    public Ray3d_SkewAndCrossBelowNGTest() {
    }
    ...
    public void testAsLine() {
        ...
        Line3d expected = line3(1, 1, 3, 2, 0, 0);
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
    ...
    public void testReverse() {
        ...
        Ray3d expected = ray3(1, 1, 3, -2, 0, 0);
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
    ...
    public void testMove() {
        ...
        Ray3d expected = ray3(2, 3, 6, 2, 0, 0);
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
    ...
    public void testClosestPoint_Line3d() {
        ...
        TPoint3d expected = point3(3, 1, 3);
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
    ...
    public void testSidedPartRay() {
        ...
        Optional<Ray3d> expected = Optional.of(ray3(2, 1, 3, 2, 0, 0));
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
    ...
    public void testSidedPartSegment_Segment3d() {
        ...
        Optional<Segment3d> expected = Optional.of(segment3(2, 1, 3, 4, 1, 3));
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
