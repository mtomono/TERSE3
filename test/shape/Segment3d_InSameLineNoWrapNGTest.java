 ...
 * @author masao
 */
public class Segment3d_InSameLineNoWrapNGTest {
    Segment3d tested = segment3(1, 1, 1, 3, 1, 1);
    Line3d line = line3(-5, 1, 1, -1, 0, 0);
    Ray3d ray = ray3(-5, 1, 1, -1, 0, 0);
    Segment3d segment = segment3(-5, 1, 1, -6, 1, 1);
    TPoint3d point = point3(-5, 1, 1);
    
    public Segment3d_InSameLineNoWrapNGTest() {
    }
