...
/**
 * test with equivalent line families
 * @author masao
 */
public class Ray3d_EquivalentNGTest {
    Ray3d tested = ray3(1, 1, 1, 2, 0, 0);
    Line3d line = line3(1, 1, 1, 4, 0, 0);
    Ray3d ray = ray3(1, 1, 1, 4, 0, 0);
    Segment3d segment = segment3(1, 1, 1, 5, 1, 1);
    TPoint3d point = point3(1, 1, 1);

    public Ray3d_EquivalentNGTest() {
    }
    ...
    public void testSidedPartSegment_Segment3d() {
        ...
        Optional<Segment3d> expected = Optional.of(segment3(1, 1, 1, 5, 1, 1));
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
