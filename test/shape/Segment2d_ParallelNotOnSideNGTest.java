 ...
 * @author masao
 */
public class Segment2d_ParallelNotOnSideNGTest {
    Segment2d tested = segment2(1, 1, 3, 1);
    Line2d line = line2(0, 2, -2, 0);
    Ray2d ray = ray2(0, 2, -2, 0);
    Segment2d segment = segment2(0, 2, -2, 2);
    TPoint2d point = point2(0, 2);
    
    public Segment2d_ParallelNotOnSideNGTest() {
    }
