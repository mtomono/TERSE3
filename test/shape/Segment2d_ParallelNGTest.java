 ...
 * @author masao
 */
public class Segment2d_ParallelNGTest {
    Segment2d tested = segment2(1, 1, 3, 1);
    Line2d line = line2(1, 2, 2, 0);
    Ray2d ray = ray2(1, 2, 2, 0);
    Segment2d segment = segment2(1, 2, 3, 2);
    TPoint2d point = point2(1, 2);
    
    public Segment2d_ParallelNGTest() {
    }
