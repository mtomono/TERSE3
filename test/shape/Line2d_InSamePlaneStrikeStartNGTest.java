 ...
 * @author masao
 */
public class Line2d_InSamePlaneStrikeStartNGTest {
    Line2d tested = line2(3, 1, 2, 0);
    Line2d line = line2(2, 0, 1, 1);
    Ray2d ray = ray2(2, 0, 1, 1);
    Segment2d segment = segment2(2, 0, 4, 2);
    TPoint2d point = point2(3, 1);
    
    public Line2d_InSamePlaneStrikeStartNGTest() {
    }
