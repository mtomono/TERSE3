 ...
 * @author masao
 */
public class Segment3d_SkewAndNotCrossBelowNGTest {
    Segment3d tested = segment3(1, 3, 1, 4, 3, 1);
    Line3d line = line3(4, 2, 0, -1, -1, 0);
    Ray3d ray = ray3(4, 2, 0, -1, -1, 0);
    Segment3d segment = segment3(4, 2, 0, 2, 0, 0);
    TPoint3d point = point3(4, 2, 0);
    
    public Segment3d_SkewAndNotCrossBelowNGTest() {
    }
    ...
    public void testAsLine() {
        ...
        Line3d expected = line3(1, 3, 1, 3, 0, 0);
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
    ...
    public void testAsRay() {
        ...
        Ray3d expected = ray3(1, 3, 1, 3, 0, 0);
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
    ...
    public void testReverse() {
        ...
        Segment3d expected = segment3(4, 3, 1, 1, 3, 1);
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
    ...
    public void testMove() {
        ...
        Segment3d expected = segment3(2, 5, 4, 5, 5, 4);
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
    ...
    public void testSidedPartSegment_Ray3d() {
        ...
        Optional<Segment3d> expected = Optional.of(segment3(1, 3, 1, 4, 3, 1));
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
