 ...
 * @author masao
 */
public class Segment3d_SkewAndCrossBelowNGTest {
    Segment3d tested = segment3(1, 1, 1, 4, 1, 1);
    Line3d line = line3(2, 0, 0, 2, 2, 0);
    Ray3d ray = ray3(2, 0, 0, 2, 2, 0);
    Segment3d segment = segment3(2, 0, 0, 4, 2, 0);
    TPoint3d point = point3(3, 1, 0);
    
    public Segment3d_SkewAndCrossBelowNGTest() {
    }
    ...
    public void testAsLine() {
        ...
        Line3d expected = line3(1, 1, 1, 3, 0, 0);
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
    ...
    public void testAsRay() {
        ...
        Ray3d expected = ray3(1, 1, 1, 3, 0, 0);
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
    ...
    public void testReverse() {
        ...
        Segment3d expected = segment3(4, 1, 1, 1, 1, 1);
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
    ...
    public void testMove() {
        ...
        Segment3d expected = segment3(2, 3, 4, 5, 3, 4);
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
    ...
    public void testAsVector() {
        ...
        TVector3d expected = vector3(3, 0, 0);
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
    ...
    public void testClosestPoint_Line3d() {
        ...
        TPoint3d expected = point3(3, 1, 1);
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
    ...
    public void testSidedPartSegment_Ray3d() {
        ...
        Optional<Segment3d> expected = Optional.of(segment3(2, 1, 1, 4, 1, 1));
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
