 ...
 * @author masao
 */
public class Segment3d_SkewAndNotInSameSideAboveNGTest {
    Segment3d tested = segment3(6, 3, 1, 9, 3, 1);
    Line3d line = line3(4, 2, 2, -1, -1, 0);
    Ray3d ray = ray3(4, 2, 2, -1, -1, 0);
    Segment3d segment = segment3(4, 2, 2, 2, 0, 2);
    TPoint3d point = point3(4, 2, 2);
    
    public Segment3d_SkewAndNotInSameSideAboveNGTest() {
    }
    ...
    public void testAsLine() {
        ...
        Line3d expected = line3(6, 3, 1, 3, 0, 0);
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
    ...
    public void testAsRay() {
        ...
        Ray3d expected = ray3(6, 3, 1, 3, 0, 0);
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
    ...
    public void testReverse() {
        ...
        Segment3d expected = segment3(9, 3, 1, 6, 3, 1);
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
    ...
    public void testMove() {
        ...
        Segment3d expected = segment3(7, 5, 4, 10, 5, 4);
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
