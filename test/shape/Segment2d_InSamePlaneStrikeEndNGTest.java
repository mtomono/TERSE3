 ...
 * @author masao
 */
public class Segment2d_InSamePlaneStrikeEndNGTest {
    Segment2d tested = segment2(4, 1, 3, 1);
    Line2d line = line2(2, 0, 1, 1);
    Ray2d ray = ray2(2, 0, 1, 1);
    Segment2d segment = segment2(2, 0, 4, 2);
    TPoint2d point = point2(3, 1);
    
    public Segment2d_InSamePlaneStrikeEndNGTest() {
    }
    ...
    public void testReverse() {
        ...
        Segment2d expected = segment2(3, 1, 4, 1);
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
