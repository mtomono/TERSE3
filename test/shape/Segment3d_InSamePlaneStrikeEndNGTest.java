 ...
 * @author masao
 */
public class Segment3d_InSamePlaneStrikeEndNGTest {
    Segment3d tested = segment3(4, 1, 1, 3, 1, 1);
    Line3d line = line3(2, 0, 1, 1, 1, 0);
    Ray3d ray = ray3(2, 0, 1, 1, 1, 0);
    Segment3d segment = segment3(2, 0, 1, 4, 2, 1);
    TPoint3d point = point3(3, 1, 1);
    
    public Segment3d_InSamePlaneStrikeEndNGTest() {
    }
    ...
    public void testAsLine() {
        ...
        Line3d expected = line3(4, 1, 1, -1, 0, 0);
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
    ...
    public void testAsRay() {
        ...
        Ray3d expected = ray3(4, 1, 1, -1, 0, 0);
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
    ...
    public void testReverse() {
        ...
        Segment3d expected = segment3(3, 1, 1, 4, 1, 1);
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
    ...
    public void testMove() {
        ...
        Segment3d expected = segment3(5, 3, 4, 4, 3, 4);
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
    ...
    public void testSidedPartSegment_Ray3d() {
        ...
        Optional<Segment3d> expected = Optional.of(segment3(4, 1, 1, 3, 1, 1));
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
