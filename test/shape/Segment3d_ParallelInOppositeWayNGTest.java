 ...
 * @author masao
 */
public class Segment3d_ParallelInOppositeWayNGTest {
    Segment3d tested = segment3(1, 1, 1, 3, 1, 1);
    Line3d line = line3(2, 2, 1, -2, 0, 0);
    Ray3d ray = ray3(2, 2, 1, -2, 0, 0);
    Segment3d segment = segment3(2, 2, 1, 0, 2, 1);
    TPoint3d point = point3(2, 2, 1);
    
    public Segment3d_ParallelInOppositeWayNGTest() {
    }
    ...
    public void testClosestPoint_TPoint3d() {
        ...
        TPoint3d expected = point3(2, 1, 1);
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
    ...
    public void testSidedPartSegment_Ray3d() {
        ...
        Optional<Segment3d> expected = Optional.of(segment3(1, 1, 1, 2, 1, 1));
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
