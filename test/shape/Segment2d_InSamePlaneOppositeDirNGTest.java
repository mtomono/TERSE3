 ...
 * @author masao
 */
public class Segment2d_InSamePlaneOppositeDirNGTest {
    Segment2d tested = segment2(1, 3, 3, 3);
    Line2d line = line2(4, 2, -1, -1);
    Ray2d ray = ray2(4, 2, -1, -1);
    Segment2d segment = segment2(4, 2, 2, 0);
    TPoint2d point = point2(4, 2);
    
    public Segment2d_InSamePlaneOppositeDirNGTest() {
    }
    ...
    public void testReverse() {
        ...
        Segment2d expected = segment2(3, 3, 1, 3);
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
