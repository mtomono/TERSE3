 ...
 * @author masao
 */
public class Line3d_ParallelNGTest {
    Line3d tested = line3(1, 1, 1, 2, 0, 0);
    Line3d line = line3(1, 2, 1, 2, 0, 0);
    Ray3d ray = ray3(1, 2, 1, 2, 0, 0);
    Segment3d segment = segment3(1, 2, 1, 3, 2, 1);
    TPoint3d point = point3(1, 2, 1);
    
    public Line3d_ParallelNGTest() {
    }
    ...
    public void testPerpendicular() {
        ...
        TVector3d expected = vector3(0, -1, 0);
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
    ...
    public void testClosestPoint_TPoint3d() {
        ...
        TPoint3d expected = point3(1, 1, 1);
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
