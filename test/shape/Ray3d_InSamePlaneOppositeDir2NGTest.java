 ...
 * @author masao
 */
public class Ray3d_InSamePlaneOppositeDir2NGTest {
    Ray3d tested = ray3(4, 1, 1, 2, 0, 0);
    Line3d line = line3(5, 3, 1, -1, -1, 0);
    Ray3d ray = ray3(5, 3, 1, -1, -1, 0);
    Segment3d segment = segment3(5, 3, 1, 2, 0, 1);
    TPoint3d point = point3(5, 3, 1);

    public Ray3d_InSamePlaneOppositeDir2NGTest() {
    }
    ...
    public void testAsLine() {
        ...
        Line3d expected = line3(4, 1, 1, 2, 0, 0);
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
    ...
    public void testReverse() {
        ...
        Ray3d expected = ray3(4, 1, 1, -2, 0, 0);
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
    ...
    public void testMove() {
        ...
        Ray3d expected = ray3(5, 3, 4, 2, 0, 0);
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
    ...
    public void testClosestPoint_Line3d() {
        ...
        TPoint3d expected = point3(4, 1, 1);
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
    ...
    public void testClosestPoint_TPoint3d() {
        ...
        TPoint3d expected = point3(5, 1, 1);
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
    ...
    public void testSidedPartSegment() {
        ...
        Optional<Segment3d> expected = Optional.of(segment3(4, 1, 1, 5, 1, 1));
        System.out.println("result  : " + result);
        System.out.println("expected: " + expected);
        assertEquals(result, expected);
    }
