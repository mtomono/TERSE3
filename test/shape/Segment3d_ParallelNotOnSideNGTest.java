 ...
 * @author masao
 */
public class Segment3d_ParallelNotOnSideNGTest {
    Segment3d tested = segment3(1, 1, 1, 3, 1, 1);
    Line3d line = line3(0, 2, 1, -2, 0, 0);
    Ray3d ray = ray3(0, 2, 1, -2, 0, 0);
    Segment3d segment = segment3(0, 2, 1, -2, 2, 1);
    TPoint3d point = point3(0, 1, 2);
    
    public Segment3d_ParallelNotOnSideNGTest() {
    }
