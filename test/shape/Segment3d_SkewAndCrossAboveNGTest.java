 ...
 * @author masao
 */
public class Segment3d_SkewAndCrossAboveNGTest {
    Segment3d tested = segment3(1, 1, 1, 4, 1, 1);
    Line3d line = line3(2, 0, 2, 2, 2, 0);
    Ray3d ray = ray3(2, 0, 2, 2, 2, 0);
    Segment3d segment = segment3(2, 0, 2, 4, 2, 2);
    TPoint3d point = point3(3, 1, 2);
    
    public Segment3d_SkewAndCrossAboveNGTest() {
    }
