 ...
 * @author masao
 */
public class ContextEnvelopChunkIteratorNGTest {
    
    public ContextEnvelopChunkIteratorNGTest() {
    }
    ...
    public void testChunk() {
        ...
        List<List<Integer>> result = i2l(new ContextEnvelopChunkIterator<>(tested.iterator(),i->i>10));
        List<TList<Integer>> expected = tested.envelopChunk(i->i>10);
