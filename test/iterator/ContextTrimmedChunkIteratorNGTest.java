 ...
 * @author masao
 */
public class ContextTrimmedChunkIteratorNGTest {
    
    public ContextTrimmedChunkIteratorNGTest() {
    }
    ...
    public void testChunk() {
        ...
        List<List<Integer>> result = i2l(new ContextTrimmedChunkIterator<>(tested.iterator(),i->i>10));
        List<TList<Integer>> expected = tested.trimmedChunk(i->i>10);
