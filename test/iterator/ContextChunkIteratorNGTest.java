 ...
 * @author masao
 */
public class ContextChunkIteratorNGTest {
    
    public ContextChunkIteratorNGTest() {
    }
    ...
    public void testChunk() {
        ...
        List<List<Integer>> result = i2l(new ChunkIterator<>(tested.iterator(),i->i>10));
        List<TList<Integer>> expected = tested.chunk(i->i>10);
    ...
    public void testChunk03() {
        ...
        List<List<Integer>> result = i2l(new ChunkReverseIterator<>(tested.iterator(),i->i>10));
