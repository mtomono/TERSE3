...
public class FractionPoweredNGTest {
    ...
    public void testSimple9800() {
        ...
        FractionPowered result = FractionPowered.create(9800,2);
    ...
    public void testSimple16() {
        System.out.println(test.TestUtils.methodName(0));
        FractionPowered result = FractionPowered.create(16,3);
    ...
    public void testSimple625() {
        System.out.println(test.TestUtils.methodName(0));
        FractionPowered result = FractionPowered.create(625,3);
    ...
    public void testSimple32() {
        System.out.println(test.TestUtils.methodName(0));
        FractionPowered result = FractionPowered.create(32,3);
    ...
    public void testSimple64() {
        System.out.println(test.TestUtils.methodName(0));
        FractionPowered result = FractionPowered.create(64,3);
    ...
    public void testSimple32_81() {
        System.out.println(test.TestUtils.methodName(0));
        FractionPowered result = FractionPowered.create(32*81,3);
    ...
    public void testSimple32_243() {
        System.out.println(test.TestUtils.methodName(0));
        FractionPowered result = FractionPowered.create(32*243,3);
