...
public class ContinuedFractionExpansionNGTest {
    ...
    public void testCfe43IntPart() {
        ...
        TList<Integer> result=new CFE<Double>().exec(C.d.b(1.33333333333333333333),1.0e-9).intPart();
    ...
    public void testCfe43Fraction() {
        System.out.println(test.TestUtils.methodName(0));
        Rational result=new CFE<Double>().exec(C.d.b(1.33333333333333333333),1.0e-9).fraction().last();
    ...
    public void testCfe17Fraction() {
        System.out.println(test.TestUtils.methodName(0));
        Rational result=new CFE<Double>().exec(C.d.b(0.14285714285),1.0e-9).fraction().last();
    ...
    public void testCfeSqrt2IntPart() {
        System.out.println(test.TestUtils.methodName(0));
        TList<Integer> result=new CFE<Double>().exec(C.d.b(sqrt(2)),1.0e-9).intPart();
    ...
    public void testCfeSqrt2Fraction() {
        System.out.println(test.TestUtils.methodName(0));
        TList<Rational> result=new CFE<Double>().exec(C.d.b(sqrt(2)),1.0e-9).fraction();
    ...
    public void testCfeRational3217IntPart() {
        System.out.println(test.TestUtils.methodName(0));
        TList<Integer> result=new CFE<Rational>().exec(C.r.b("32/17"),Rational.parseRational("1/1000000000")).intPart();
    ...
    public void testCfeRational3217Fraction() {
        System.out.println(test.TestUtils.methodName(0));
        TList<Rational> result=new CFE<Rational>().exec(C.r.b("32/17"),Rational.parseRational("1/1000000000")).fraction();
