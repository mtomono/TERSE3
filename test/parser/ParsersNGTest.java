...
public class ParsersNGTest {
    ...
    public void testSequence1() {
        ...
        String result = null;
        try {
            result = seq(letter, rep(2, digit)).l().parse(s);
        } catch (ParseException e) {
    ...
    public void testOr4() {
        ...
        String result = null;
        try {
            result = many(letter.or(digit)).l().parse(s);
        } catch (ParseException e) {
    ...
    public void testOr7() {
        ...
        String result = null;
        try {
            result = sequence(a, b).or(sequence(c, b)).l().parse(s);
        } catch (ParseException e) {
    ...
    public void testOr10() {
        ...
        String result = null;
        try {
            result = sequence(a, b).or(sequence(a, c)).l().parse(s);
        } catch (ParseException e) {
    ...
    public void testOr12() {
        ...
        String result = null;
        try {
            result = sequence(a, b.or(c)).l().parse(s);
        } catch (ParseException e) {
    ...
    public void testMor1() {
        ...
        String result = null;
        try {
            result = or(seq(a, b).tr(), seq(a, c).tr(), seq(a, a)).l().parse(s);
        } catch (ParseException e) {
    ...
    public void testManyUpto1() {
        ...
        String result = null;
        try {
            result = manyUpto(2, 4, a).l().parse(s);
        } catch (ParseException e) {
    ...
    public void testReduceOnParser() {
        ...
        Integer result = null;
        try {
            result = digit.l().apply(l->Integer.parseInt(l)).reduce((v, u)->v+u, 0).parse(s);
        } catch (ParseException e) {
    ...
    public void testRelayToAnotherParser() {
        ...
        String result = null;
        try {
            result = many(digit).l().relay(many(letter).l(), (u, v)->v+u).parse(s);
        } catch (ParseException e) {
