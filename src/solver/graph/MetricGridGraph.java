 ...
 * @param <K>
 */
public class MetricGridGraph<K extends List<Integer>> implements MetricGraph<K> {
    public final GridCoord gcoord;
    public final TVector3d weight;
    public final TList<K> dirs;
    Function<List<Integer>,K> translator;
    
    public MetricGridGraph(GridCoord gcoord, TList<K> dirs, TVector3d weight, Function<List<Integer>,K>translator) {
        this.gcoord = gcoord;
        this.dirs = dirs;
