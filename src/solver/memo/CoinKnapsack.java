 ...
 * @author masao
 */
public class CoinKnapsack extends DP<TPoint2i, Result<Integer>>{
    ...
    Result<Integer> valueCore(int i, int rest, TList<TPoint2i> c) {
        ...
        return TList.sof(value(i+1,rest), value(i,rest-c.get(i).x).add(i,v->v+c.get(i).y)).max(inc(x->x.value)).get();
    }
}
